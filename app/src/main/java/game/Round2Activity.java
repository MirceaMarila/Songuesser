...
public class Round2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play = findViewById(R.id.play_btn_2);
        pause = findViewById(R.id.pause_btn_2);
        stop = findViewById(R.id.stop_btn_2);
        v1 = findViewById(R.id.r2v1);
        v2 = findViewById(R.id.r2v2);
        v3 = findViewById(R.id.r2v3);
        v4 = findViewById(R.id.r2v4);
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v4.setBackgroundColor(Color.GREEN);
    ...
    public void play(View v){
        if(player == null){
            Context context;
            player = MediaPlayer.create(this, R.raw.now_that_we_are_dead);
